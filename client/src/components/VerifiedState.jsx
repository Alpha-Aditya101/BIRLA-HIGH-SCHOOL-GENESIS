...
export default function VerifiedState({ jobId, attempt, gameUrl, healCycles, bugsFixed, spec, usedFallback = false, onReset }) {
  ...
  return (
    <div className="verified-state fade-in">
      {usedFallback && (
        <div className="pipeline-error" role="alert" style={{ marginBottom: 16 }}>
          <div>
            <strong>Gemini unavailable (quota or overload):</strong> the built-in template game is shown below.
            It passed the playtest suite but was <strong>not generated by AI</strong> from your prompt. Try again later.
          </div>
        </div>
      )}
      {/* ── Hero banner ── */}
      <div className="verified-hero">
        ...
        <div className="verified-headline">
          <h2>{usedFallback ? 'Template' : 'Verified'}<br /><span>{usedFallback ? 'Fallback' : 'Playable'}</span></h2>
      ...
      <div className="verified-game-wrap">
        <div className="verified-game-label">
          <span className="verified-badge">{usedFallback ? '⚠ TEMPLATE — NOT AI-GENERATED' : '✓ VERIFIED PLAYABLE'}</span>
